...
<div class="wrapper">
	<div id="my_payment_view_details">
		<?php
		...
		<ul id="order_details">
			...
			<div id="payment_done" >Payment Successfully Completed</div>
		<div id="my_payment_view_details_div">
			<div id="my_payment_view_details_table">
				...
				<div class="clear"></div>
				<a href="my_payment.php"><p id="back">Back</p></a>
			</div>
		</div>
		<div class="clear"></div>
	</div>
