...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2016 at 02:03 PM
...
INSERT INTO `tbl_order` (`o_id`, `cu_id`, `ve_id`, `clothes`, `quantities`, `transac_id`, `amount`, `date_time`) VALUES
(7, 6, 27, '16,17', '1,1', '07307546T0645134V', 15, '2016-03-28 19:13:55');
...
--
ALTER TABLE `tbl_order`
  MODIFY `o_id` int(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `tbl_user`
  MODIFY `u_id` int(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
